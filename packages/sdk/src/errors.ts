// Typed error hierarchy for the Grantwell SDK.
//
...
// codes (forward compatibility) fall back to the generic `GrantwellError`
...
export interface GrantwellErrorInit {
 ...
 * `quota_exceeded`) decode to this class — `instanceof GrantwellError`
 * still matches.
 */
export class GrantwellError extends Error {
  ...
  constructor(init: GrantwellErrorInit) {
    super(init.envelope.message);
    this.name = "GrantwellError";
...
export class BadRequestError extends GrantwellError {
  constructor(init: GrantwellErrorInit) {
    super(init);
...
export class UnauthenticatedError extends GrantwellError {
  constructor(init: GrantwellErrorInit) {
    super(init);
...
export class ForbiddenError extends GrantwellError {
  constructor(init: GrantwellErrorInit) {
    super(init);
...
export class NotFoundError extends GrantwellError {
  constructor(init: GrantwellErrorInit) {
    super(init);
...
export class ConflictError extends GrantwellError {
  constructor(init: GrantwellErrorInit) {
    super(init);
...
export class ValidationError extends GrantwellError {
...
export class PreconditionFailedError extends GrantwellError {
  constructor(init: GrantwellErrorInit) {
    super(init);
...
export class UnsupportedError extends GrantwellError {
  constructor(init: GrantwellErrorInit) {
    super(init);
...
export class InternalError extends GrantwellError {
  constructor(init: GrantwellErrorInit) {
    super(init);
...
export interface RateLimitErrorInit extends GrantwellErrorInit {
...
export class RateLimitError extends GrantwellError {
...
/**
 * Decode an HTTP `Response` into the appropriate `GrantwellError` subclass.
 *
 * Forward-compatible: unknown error codes resolve to the base `GrantwellError`.
...
export async function decodeError(
  ...
  switch (envelope.code as ErrorCode) {
    ...
    default:
      ...
      return new GrantwellError(init);
  }
}

function decodeRateLimit(
  init: GrantwellErrorInit,
  response: Response,
): RateLimitError {
