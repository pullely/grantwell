...
//   - GrantwellError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): Grantwell {
  return new Grantwell({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the Grantwell class", () => {
