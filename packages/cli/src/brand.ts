...
// `@saas/sdk` client class name (`Grantwell`) is intentionally NOT part of
...
export const CLI_BIN = "grantwell";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "Grantwell";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.grantwell.app";
