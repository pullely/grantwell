...
//   - `~/.config/grantwell/credentials.json` (0600)
//   - `~/.config/grantwell/config.json`     (0644)
//
// Override via `GRANTWELL_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/grantwell` everywhere
