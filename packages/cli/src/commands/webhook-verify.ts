// `grantwell webhook verify` — local cryptographic verification of a
// Grantwell outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `grantwell login`.
