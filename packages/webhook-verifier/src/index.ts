 ...
 * signature verifier for Grantwell outbound webhook deliveries.
 *
...
/**
 * Compute the canonical Grantwell webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a Grantwell webhook delivery.
 *
